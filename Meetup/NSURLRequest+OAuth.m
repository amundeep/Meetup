...
static NSString * const kConsumerKey       = @"6zFP7BE5dY1MWh-GyqFz1A";
static NSString * const kConsumerSecret    = @"-Dqn-il2h2yflGvZwlbBF6nEAxo";
static NSString * const kToken             = @"xyPB40vNDdEATL7XGFH28M9IT_lyiVNX";
static NSString * const kTokenSecret       = @"FsxCcrb1V6ovJguOoq0182CDbUY";
